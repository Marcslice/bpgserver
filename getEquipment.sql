CREATE FUNCTION get_equipment (@playerId int)
...
AS
  BEGIN
	...
	INSERT INTO @t (piece, equipName)
	VALUES (@piece, @equipName)
	...
	SELECT @piece = N'Necklass', @equipName = equipmentName,@equipDmg = equipmentATK, @equipDef = equipmentDEF
